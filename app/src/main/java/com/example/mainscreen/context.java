...
public class context extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button = (Button) findViewById(R.id.시작);

        Intent intent = getIntent();
        final String 단원명=intent.getExtras().getString("단원명");
        String 소단원명1=intent.getStringExtra("소단원명1");
        String 소단원명2=intent.getStringExtra("소단원명2");
        String 소단원명3=intent.getStringExtra("소단원명3");
